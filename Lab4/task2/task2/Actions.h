...
void PrintActions()
{
	...
	std::cout << "5. Change university" << std::endl;
	std::cout << "6. Change student" << std::endl;
	std::cout << "7. Change student's university" << std::endl;
	std::cout << "8. Print universities" << std::endl;
	std::cout << "9. Print students from university" << std::endl;
	std::cout << "10. Print students" << std::endl << std::endl;
